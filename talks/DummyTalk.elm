...
world =
  (Transform.transformWorld (Position 0 0) (Size 1000 1000) ElmLogo.logo)
  ++
  [ Text
    <| TextObject "Hello World" Color.white "Helvetica" 0.1 Center 1
    <| Position 500 250
  , Text
...
frames = 
  Frames
    ...
    (Frame (Position 0 0) (Size 4196 3072) 0)
